...
class BrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create brain" do
    assert_difference('Brain.count') do
      post brains_url, params: { brain: { flavor: @brain.flavor, status: @brain.status, zombie_id: @brain.zombie_id } }
    end
  ...
  test "should update brain" do
    patch brain_url(@brain), params: { brain: { flavor: @brain.flavor, status: @brain.status, zombie_id: @brain.zombie_id } }
